...
import com.bolsadeideas.springboot.backend.apirest.service.ClienteService;
...
public class ClienteRestControler {
    ...
    private final org.slf4j.Logger log = LoggerFactory.getLogger(ClienteRestControler.class);
    ...
    public ResponseEntity<?> delete(@PathVariable Long id) {
        ...
        try {
            ...
            String nombreFotoAnterior = cliente.getImage();
